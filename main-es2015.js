...
/* harmony import */ var ngx_countdown__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-countdown */ "./node_modules/ngx-countdown/fesm2015/ngx-countdown.js");
...
let BaithiComponent = class BaithiComponent {
    constructor(http, route, listQuestion, userSV, cook, route2) {
        this.http = http;
        this.route = route;
...
BaithiComponent.ctorParameters = () => [
...
let DangkiComponent = class DangkiComponent {
    constructor(listStudents, http, router) {
...
let DangnhapComponent = class DangnhapComponent {
    constructor(listStudents, http, router, cook) {
        this.listStudents = listStudents;
        this.http = http;
        this.router = router;
        this.cook = cook;
...
DanhmucmonhocComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _server_server_service__WEBPACK_IMPORTED_MODULE_3__["ServerService"] }
];
...
let QuenmatkhauComponent = class QuenmatkhauComponent {
    constructor(listStudents, http, route) {
        this.listStudents = listStudents;
        this.http = http;
        this.route = route;
        this.Info = {
...
ListUserService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let ThongtinComponent = class ThongtinComponent {
    constructor(http, ListUser, route) {
        this.http = http;
...
ThongtinComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
